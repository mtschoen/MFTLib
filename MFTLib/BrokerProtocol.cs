...
public static class BrokerProtocol
{
    ...
    public static BrokerFrame ReadFrame(ReadOnlySpan<byte> span, out int consumed)
    {
        ...
        return kind switch
        {
            BrokerFrameKind.ArmAndScan => new BrokerFrame(
                Kind: kind,
                Drive: null,
                Cursor: default,
                ...
                ByteLength: 0,
                Message: null,
                DrivesSpec: ReadString(payload, 0, out _)),

            BrokerFrameKind.StartWatch => new BrokerFrame(
                Kind: kind,
                Drive: null,
                Cursor: default,
                Entries: Array.Empty<UsnJournalEntry>(),
            ...
            BrokerFrameKind.Shutdown => new BrokerFrame(
                Kind: kind,
                Drive: null,
                Cursor: default,
                Entries: Array.Empty<UsnJournalEntry>(),
            ...
            BrokerFrameKind.Heartbeat => new BrokerFrame(
                Kind: kind,
                Drive: null,
                Cursor: default,
                Entries: Array.Empty<UsnJournalEntry>(),
            ...
            BrokerFrameKind.EndWatch => new BrokerFrame(
                Kind: kind,
                Drive: null,
                Cursor: default,
                Entries: Array.Empty<UsnJournalEntry>(),
            ...
            BrokerFrameKind.EndWatchAck => new BrokerFrame(
                Kind: kind,
                Drive: null,
                Cursor: default,
                Entries: Array.Empty<UsnJournalEntry>(),
    ...
    static BrokerFrame ReadCursorFrame(ReadOnlySpan<byte> payload)
    {
        ...
        return new BrokerFrame(
            ...
            Drive: drive,
            Cursor: new UsnJournalCursor(journalId, nextUsn),
            Entries: Array.Empty<UsnJournalEntry>(),
            MmfName: null,
            RecordCount: 0,
            ByteLength: 0,
